...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../../views/css/user configuration interface1.css">
    <link rel="stylesheet" href="../../views/css/user configuration interface1.css">
...
<body>
    <header>
        <!-- Acá va el layout (navbar) -->
         <div class="name" ></div><h1>Configuracion</h1></div>
    </header>
    <main>
    <div class="container">
        <section>
            <div class="text">
                ...
                <img src="../../views/img/S1DPU8qK_400x400.jpg" loading="lazy" width="200" height="200">
        ...
        <section class="contentPage">
            ...
            <h2>Modificar Nombre de Usuario BENI MONO UNGA UNGA</h2>
            <form>
